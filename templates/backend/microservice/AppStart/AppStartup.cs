...
namespace --ProjectFullName--.AppStart
{
    public class AppStartup : IAppStartup
    {
        ...
        private IBusinessTripApplicationConfig _applicationConfig;
        ...
        public void SetServerContainer(IContainer container)
        {
            ...
            _applicationConfig = container.Resolve<IBusinessTripApplicationConfig>();
        ...
        {
            var businessTripList = new H2OAngularState
            {
                Title = "--ProjectName--",
            ...
            application.AngularStates.Add(businessTripList);
        }
    }
}
